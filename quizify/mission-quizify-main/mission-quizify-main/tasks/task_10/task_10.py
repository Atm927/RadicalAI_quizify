    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                topic_input = st.text_input("Topic for Quiz", placeholder="Enter the topic of the document")
                ...
                if submitted:
                    ...
                    generator = QuizGenerator(topic_input, questions,
                                              chroma_creator)  # Step 3: Initialize a QuizGenerator class using the topic, number of questrions, and the chroma collection
